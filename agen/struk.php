...
<body onload="window.print()"  style="font-family:monospace;" >
	<table style="background: url('../images/struk.jpg') center no-repeat;
			background-size: 50%;">
		<tr>
		...
		<tr>
			<td colspan="6" align="center">Arya Dillah - Sertifikasi Programmer/<?php echo $_SESSION['nama_agen']."/".$pembayaran['waktu_bayar']; ?></td>
		</tr>
	</table>
</body>
</html>