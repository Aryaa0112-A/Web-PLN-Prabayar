...
<html>
<head>
	<title>FORM LOGIN E-TROLLS COMPANY</title>
					...
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<div style="margin-top: 5px;margin-bottom: 5px;">
								<img src="../images/logo_e-trolls.png" alt="logo" class="logo" width="90px">
							</div>
							...
							<div class="col-md-12">
								<form method="post">
									...
									<div class="button input-box">
										<p class="text sign-up-text">Don't have an account? <a href="register.php">Register</a></p>
									</div>
								</form>
							</div>
						</div>
						...
						<div class="panel-footer">
							<center>&copy;<?php echo date("Y"); ?> - Arya Dillah-12220383</center>
						</div>
						<!-- end footer -->
					</div>
				</div>
